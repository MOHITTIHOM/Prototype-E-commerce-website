...
<html lang="en">
  <head>
	...
	<link href="projectCss/books.css" rel="stylesheet">
...
?>
	...
	<?php
		...
		<div class="container" id="';?><?php echo'book'.$row[0].'" >
			<div class="row">
...
<!-- collapse template-->
					...
					<p class="bold">
					<a href="books.php?product_id=';?><?php echo $row[0].'"><button class="btn btn-success">Add To Cart</button></a></p>
					</div>	
			</div>
		</div>
